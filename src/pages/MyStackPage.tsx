...
import javaSVG from "../assets/images/stacks/java.svg";
import javascriptSVG from "../assets/images/stacks/javascript.svg";
import pythonSVG from "../assets/images/stacks/python.svg";
import phpSVG from "../assets/images/stacks/php.svg";
...
const MyStackPage = () => {
    return (
        <>
             <Helmet>
                <title>Technologies & Skills | Manitra RASOLOFOARIMANGA</title>
                <meta name="description" content="Discover the technologies and skills of Manitra RASOLOFOARIMANGA, from Fullstack development to Machine Learning, with modern tools and innovative frameworks." />
                <meta name="keywords" content="Stacks, Technologies, Fullstack Developer, Machine Learning, Web Development, Tools, Frameworks, Technical Skills" />
            </Helmet>
